...
var Rule = /** @class */ (function(_super) {
  ...
  Rule.metadata = {
    ...
    options: { include: "srting", exclude: "me" },
    optionExamples: [true],
    type: "typescript",
    typescriptOnly: true,
  };
...
function walk(ctx) {
  if (
    ctx.options[0].include.some(extention => {
      return !!ctx.sourceFile.fileName.match(extention);
    }) &&
    !ctx.options[0].exclude.some(extention => {
      return !!ctx.sourceFile.fileName.match(extention);
    })
  )
